...
public class EmployeController {
    ...
    public ResponseEntity<Employee> updatePassword(@PathVariable int    employeeId,
                                                   @RequestBody EmployeePasswdRequest request) {
        System.out.println("hata burada 1");
        Employee updatedEmployee = employeeService.passwdup(employeeId, request);
